 ...
 * com.bbva.pzic.proposals.util.orika.javolution.context.AllocatorContext allocation} policies (e.g.&nbsp;
 * {@link com.bbva.pzic.proposals.util.orika.javolution.context.StackContext "stack"} allocations).</p>
 * <p/>
 * <p> Instances of this class are typically created through an
 * {@link com.bbva.pzic.proposals.util.orika.javolution.context.ObjectFactory ObjectFactory}. For example:
 * [code]
 ...
 * {@link com.bbva.pzic.proposals.util.orika.javolution.context.AllocatorContext allocators} (Javolution).</p>
 *
...
public interface Realtime {
     ...
     * can be {@link com.bbva.pzic.proposals.util.orika.javolution.context.StackContext "stack"} allocated and
