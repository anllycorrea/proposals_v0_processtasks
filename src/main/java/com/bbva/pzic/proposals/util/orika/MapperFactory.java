...
public interface MapperFactory {
     ...
     * @param includeAutoGeneratedMappers specifies whether an auto-generated mapper for the given
     ...
     * @param targetClass   the type which is generated by the given object factory
     ...
     *
     * @param mapperKey the MapperKey which should be used to look up an associated
     *                  ClassMap
     ...
     *
     * @param aType the 'A' type for the returned DedicatedMapperFacade
     * @param bType the 'B' type for the returned DedicatedMapperFacade
     */
     ...
     * @param aType          the 'A' type for the returned DedicatedMapperFacade
     * @param bType          the 'B' type for the returned DedicatedMapperFacade
     * @param containsCycles true if the object graph for the source and destination types
