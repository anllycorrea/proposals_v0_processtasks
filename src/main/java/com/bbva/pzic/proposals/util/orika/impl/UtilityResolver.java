...
import com.bbva.pzic.proposals.util.orika.constructor.SimpleConstructorResolverStrategy;
import com.bbva.pzic.proposals.util.orika.converter.ConverterFactory;
import com.bbva.pzic.proposals.util.orika.converter.DefaultConverterFactory;
import com.bbva.pzic.proposals.util.orika.impl.generator.CompilerStrategy;
import com.bbva.pzic.proposals.util.orika.impl.generator.JavassistCompilerStrategy;
import com.bbva.pzic.proposals.util.orika.metadata.ClassMapBuilderFactory;
import com.bbva.pzic.proposals.util.orika.property.ListPropertyResolverStrategy;
...
public abstract class UtilityResolver {
    ...
    public static ClassMapBuilderFactory getDefaultClassMapBuilderFactory() {
        return resolveUtility(OrikaSystemProperties.CLASSMAP_BUILDER_FACTORY, com.bbva.pzic.proposals.util.orika.metadata.ClassMapBuilder.Factory.class);
    }
