...
public interface ConverterFactory {
     ...
     * @return converter
     */
    com.bbva.pzic.proposals.util.orika.Converter<Object, Object> getConverter(Type<?> sourceType, Type<?> destinationType);
     ...
     * @param converterId
     * @param converter
     * @deprecated use {@link #registerConverter(com.bbva.pzic.proposals.util.orika.Converter)} instead
     */
    @Deprecated
    <S, D> void registerConverter(com.bbva.pzic.proposals.util.orika.converter.Converter<S, D> converter);
     ...
     * @param converterId
     * @param converter
     * @deprecated use {@link #registerConverter(String, com.bbva.pzic.proposals.util.orika.Converter)} instead
     */
    @Deprecated
    <S, D> void registerConverter(String converterId, com.bbva.pzic.proposals.util.orika.converter.Converter<S, D> converter);
