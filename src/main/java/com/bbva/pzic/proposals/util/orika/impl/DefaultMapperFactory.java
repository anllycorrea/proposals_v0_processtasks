...
public class DefaultMapperFactory implements MapperFactory {
     ...
     * @param superTypeStrategy true if the passed UnenhanceStrategy should take full
     ...
     * @param typeA
     * @param typeB
     * @param includeAutoGeneratedMappers whether auto-generated mappers should be included in the
     *                                    lookup
     * @return a registered Mapper which is able to map the specified types
     */
    @SuppressWarnings("unchecked")
    ...
    public <A, B> ClassMapBuilder<A, B> classMap(Type<A> aType, Class<B> bType) {
        return classMap(aType, TypeFactory.valueOf(bType));
    }

    public <A, B> ClassMapBuilder<A, B> classMap(Class<A> aType, Class<B> bType) {
        return classMap(TypeFactory.valueOf(aType), TypeFactory.valueOf(bType));
    }
