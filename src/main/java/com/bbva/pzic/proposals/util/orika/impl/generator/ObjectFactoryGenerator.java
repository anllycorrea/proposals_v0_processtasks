...
import com.bbva.pzic.proposals.util.orika.impl.GeneratedObjectFactory;
...
public class ObjectFactoryGenerator {
    ...
    private void addSourceClassConstructor(CodeSourceBuilder out, Type<?> type, Type<?> sourceType, MappingContext mappingContext, StringBuilder logDetails) {
        ...
        if (type.isArray()) {
            ...
            ConstructorResolverStrategy.ConstructorMapping<?> constructorMapping = (ConstructorResolverStrategy.ConstructorMapping<?>) constructorResolverStrategy.resolve(classMap, type);
