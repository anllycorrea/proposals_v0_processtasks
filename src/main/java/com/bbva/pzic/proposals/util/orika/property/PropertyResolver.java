...
public abstract class PropertyResolver implements PropertyResolverStrategy {
        ...
        if (properties == null) {
            synchronized (theType) {
                ...
                if (properties == null) {
                    ...
                    com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType;

                    if (theType instanceof com.bbva.pzic.proposals.util.orika.metadata.Type) {
                        referenceType = (com.bbva.pzic.proposals.util.orika.metadata.Type<?>) theType;
     ...
     * @return
     */
    private com.bbva.pzic.proposals.util.orika.metadata.Type<?> resolveGenericType(java.lang.reflect.Type genericType, com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType) {
        com.bbva.pzic.proposals.util.orika.metadata.Type<?> resolvedType = null;
        com.bbva.pzic.proposals.util.orika.metadata.Type<?> reference = referenceType;
        do {
    ...
    protected void processProperty(String propertyName, Class<?> propertyType, Method readMethod, Method writeMethod, Class<?> owningType,
                                   com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType, Map<String, Property> properties) {
    ...
    public com.bbva.pzic.proposals.util.orika.metadata.Type<?> resolvePropertyType(Method readMethod, Class<?> rawType, Class<?> owningType, com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType) {

        rawType = resolveRawPropertyType(rawType, readMethod);

        com.bbva.pzic.proposals.util.orika.metadata.Type<?> resolvedGenericType = null;
     ...
     */
    protected void collectPublicFieldProperties(com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType, Map<String, Property> properties) {
        ...
        for (Field f : referenceType.getRawType().getFields()) {
            if (!Modifier.isStatic(f.getModifiers())) {
                ...
                com.bbva.pzic.proposals.util.orika.metadata.Type<?> genericType = resolveGenericType(f.getGenericType(), referenceType);
    ...
    public Property resolveInlineProperty(java.lang.reflect.Type type, String expr) {
        com.bbva.pzic.proposals.util.orika.metadata.Type<?> theType = TypeFactory.valueOf(type);
     ...
     */
    protected abstract void collectProperties(Class<?> type, com.bbva.pzic.proposals.util.orika.metadata.Type<?> referenceType, Map<String, Property> properties);
