...
/**
 * Bean de respuesta para la transacci&oacute;n <code>UGLP</code>
 *
...
@Multiformato(formatos = {FormatoUGMSGLP2.class, FormatoUGMSGLP1.class})
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionUglp implements MensajeMultiparte {
