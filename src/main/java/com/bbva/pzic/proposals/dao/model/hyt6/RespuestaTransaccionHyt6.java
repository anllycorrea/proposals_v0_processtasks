...
/**
 * Bean de respuesta para la transacci&oacute;n <code>HYT6</code>
 *
...
@Multiformato(formatos = {FormatoHYMR602.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionHyt6 implements MensajeMultiparte {
