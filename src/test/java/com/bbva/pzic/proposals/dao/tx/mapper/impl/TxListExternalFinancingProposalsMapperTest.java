...
public class TxListExternalFinancingProposalsMapperTest {
    ...
    public void mapInFullTest(){
        DTOInputListExternalFinancingProposals dtoIn = dummnyMock.getDtoInputListExternalFinancingProposals();
    ...
    public void mapOut1FullTest() throws IOException {
        enumMapOut();
        List<FormatoUGMSGLP1> ugmsglp1List = dummnyMock.getFormatoUGMSGLP1List();
    ...
    public void mapOut2FullTest(){
        FormatoUGMSGLP2 ugmsglp2 = dummnyMock.getFormatoUGMSGLP2();
    ...
    @Test
    public void mapOut2DTOOutNullTest(){
        FormatoUGMSGLP2 ugmsglp2 = dummnyMock.getFormatoUGMSGLP2();
    ...
    @Test
    public void mapOut2PaginationNullTest(){
        FormatoUGMSGLP2 ugmsglp2 = dummnyMock.getFormatoUGMSGLP2();
        ugmsglp2.setTampagi(null);
        ugmsglp2.setIdpagin(null);
        DTOOutExternalFinancingProposalData proposalData = proposalsMapper.mapOut2(ugmsglp2,new DTOOutExternalFinancingProposalData());
